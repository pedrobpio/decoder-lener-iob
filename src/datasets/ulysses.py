import logging
from datasets import load_dataset, DatasetDict, Features, Value, ClassLabel, Sequence

logging.basicConfig(level=logging.INFO)
logger = logging.getLogger(__name__)

class UlyssesDataset:
    ...
    def load_dataset(self):
        logger.info(f"Loading Ulysses NER dataset PL V2")
        logger.info(f"Loading dataset: {self.dataset_name}")
        loaded_data = load_dataset(self.dataset_name,'UlyssesNER-Br-PL-coarse')
